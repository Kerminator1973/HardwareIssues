...
7. Мы не знаем, как влияет разлчие версий PCI Express поддерживаемых motherboard (3.0) и видео-картой (4.0). Теоретически, потери производительности должны составлять 5-10%
