...
Поскольку система используется и для обучения (сейчас сессия), и для отдыха, принятие кардинальных мер, связанных с перестановкой операционной системы практически исключено. Из наименее кардинальных мер можно рассматривать два:
...
1. Использования HDD в современных компьютерах для загрузки операционной системы уже не приемлемо
