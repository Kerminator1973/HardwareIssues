...
Утром 13 декабря 2023 года две первых попытки загрузки были неуспешными. Система зависала на экране ввода пароля, а второй раз - при формировании пользовательского интерфейса после успешной аутентификации пользователя.

Таким образом, единственный оставшийся подозреваемый - аппаратное обеспечение: процессор, материнская плата, память, блок питания.

Пока установлена Ubuntu 23.04 с Grub, следует выполнить проверку оперативной памяти. Для этого нужно запускать машины с зажатой кнопеой **Shift** и выбрать вариант "test MemoryCheck86+".
