...
Зависания при холодном старте продолжаются.

В системном журнале есть информация о термальных зонах процессора (_TZ.TZ00), которые связаны с настройками скорости работы вентилятора (_AC0-_AC9):
...
Также может быть полезным проверить систему на вирусы, скачав с официального сайта Касперского образ Live-USB.

Ещё одна возможная причина проблем - видео-карта, или драйвер видео-карты. Видео-карта сопоставима по сложности с материнской платой и процессором одновременно. Следует попробовать отключить видео-карту и перейти на интегрированную графику. Как вариант, можно рассмотреть удаление видео-драйвера от Nvidia и временный переход на драйверы VESA.
...
## Тестирование стабильности загрузки в Linux

12 декабря 2023 года на отдельный SSD (Patriot M.2 512Gb) был установлен Ubuntu Mate 23.04.

Утром и вечером 13 декабря 2023 года две первых попытки загрузки были неуспешными. Система зависала на экране ввода пароля, а второй раз - при формировании пользовательского интерфейса после успешной аутентификации пользователя.

Проверить корректность работы оперативной памяти можно используя утилиту [MemTest86+](https://memtest.org/). С официального сайта скачивается приложение для создания загрузочного USB-диска, который сразу же при загрузке с носителя запускает тестирование. Продолжительность тестирования составляет около получаса.

Что касается удобства/недостатков Ubuntu Mate, то реальной болью является работа с буфером обмена через клавиатуру. Привычные для Windows комбинации клавиш работают не так, как привык. По каким-то причинам Visual Studio Code копирует не выделенный блок, а целую строку, на которой стоит курсор.

Единственный тест, который я до сих пор не выполнил - запуск системы без дискретной графической карты. Нюанс состоит в том, что один из ПИН-ов материнской платы, связанный с интегрированной графикой погнут и контакт не очень надёжный. По этой причине, переход на интегрированную графику чреват систематическими зависаниями.

Таким образом, оставшийся подозреваемые: процессор (деградация, теплопроводная паста), материнская плата (деградация конденсатор), блок питания (дефекты питания).

**Для информации**: конденсаторы выполняют ряд важных функций в материнской плате, таких как сглаживание напряжения, регулирование напряжения и устранение помех. Правильный выбор и качество конденсаторов являются ключевыми моментами для стабильной и безопасной работы компьютера.

Как понять что конденсатор вышел из строя? Один из самых простых способов — визуальная проверка. Посмотрите на конденсатор — если он вздулся, имеет видимые трещины или следы утечки электролита, скорее всего, он вышел из строя.

При длительном перерыве в работе, то есть при отсутствии на конденсаторе напряжения в течении этого времени, происходит постепенное разрушение диэлектрика (оксида алюминия) при его взаимодействии с электролитом в отсутствии напряжения на обкладках конденсатора. Это приводит к утончению диэлектрического слоя, к увеличению тока утечки и как следствие, увеличению вероятности пробоя конденсатора при подаче на него номинального напряжения. Обычно, этот эффект начинает проявляться при перерыве в работе конденсатора длительностью более года.

Кроме того, электролитические конденсаторы подвержены высыханию. Подобных недостатков лишены полимерные конденсаторы.

Однако, в моей материнской плате используются твердотельные конденсаторы, что делает версию о проблеме с конденсатором маловероятной.

Вместе с тем, при отключении UPS (компьютер целый день простоял без питания), компьютер около 10 минут не включался вообще.

При принятии решения о замене аппаратного обеспечения изучал наткнулся на видео, в котором сборщик систем рассказывал о распространённой ошибки - использовании башенных куллеров без обеспечения должного охлаждения компонентов материнской платы. По словам автора видео, ошибка является распространённой и приводит к постепенному выгоранию элементов цепи питания. По озвученным симптомам похожа не то, что происходило у меня.

Принял решение заменить и материнскую плату, и процессор. Предыдущие прослужиди 3 года и один месяц. СПАСИБО за работу!

### В чём была проблема

**Update**: материнская плата выставлена на продажу на Митинском рынке. Предварительно, продавцы провели диагностику материнской платы и установили, что в socket-е процессора было сломано две ножки, которые отвечают за обмен данными с плашками ОЗУ. При отключении соответствующих слотов модулей памяти, система работоспособна. Т.е. можно было бы оставить из четырёх слотов только два и это сохранило бы работоспособность системы.

## Принято решение о замене материнской платы и процессора

Заказал Intel Core i3-13100 (Box с coller-ом) и материнскую плату GIGABYTE B760 DS3H DDR4 (LGA1700, ATX).

С целью обеспечения плана "Б" с Windows, скачал Media Creation Tool и образ Microsoft Windows 10. В декабре 2023 года, Microsoft уже позволяет скачивать операционную систему со своего сайта.

**Update**: новая система успешно запустилась. Windows нашла и обновила необходимые драйвера. Лицензия не слетела и я вернулся на Windows 11.

Комплектация материнской платы GIGABYTE B760 DS3H бедная. Не положили _cover plate_ для SSD и бумажную документацию.

Не стал устанавливать дискретную видео-карту (не планирую играть на компьютере) и не стал устанавливать второй SSD - пока реальной потребности в нём нет. Со временем, добавлю в систему второй SSD, но с уже установленной операционной системой (Linux), чтобы создать на нём полноценное рабочее место программиста Linux. Выбирать загрузочный SSD легко можно при запуске компьютера.

**Update**: идея интересная, но спорная. Запускать "чистый" Linux без прослойки в виде Windows/VMware - отличная идея для локального запуска LLM на видео-картах AMD Radeon, но для рабочего места программиста - удобнее и проще использовать виртуальную машину.

## Работа с SSD

В январе 2024 года поставил второй SSD (на 512Gb), предварительно удалив на нём Linux Partition у переформатировав его на NTFS. Для этого я загрузил Ubuntu Mate с USB-диска и запустив утилиту **disks** (GParted) удалил Partition.

При установке второго SSD температура процессора повысилась на 1-2 градуса. Это не особенно критично, но поскольку реальной потребности в большом объёме данных пока нет, снова вытащил SSD-диск из компьютера.

## Глюки при Backup-а данных на HDD Seagate 2TB

5 апреля 2025 года не удалось выполнить создание backup-а из-за того, что постоянно прерывалось соединение с жестким диском Seagate 2TB. 

26 апреля в тот же USB-разъём на верхней панели корпуса, подключаемый через отдельный USB-кабель в корпусе, возникли ошибки работы с USB-мышью. До этого, постоянно терялось Bluetooth-соединение через Dongle, подключенный через тот же USB-разьём: второй слева (корпус).

26 апреля диск Seagate 2TB был подключен через USB-HUB с автономным питанием через USB 3.0 разъём материнской платы компьютера. Backup удалось выполнить без каких-либо проблем, вполне успешно.

Вывод: проблема не с диском, а с подключением внешней платы с USB-разъёмами на корпусе.

>При подключении SSD-диска Patriot 512 GB, периодически отваливается USB-dongle Wi-Fi, который подключен по USB к разъёму на материнской плате.

## Требования к объёму ОЗУ в реалиях использования ИИ

Обратил внимание, что комбинация GigaIDE с активированным GigaChat, а также VMware 17 с запущенной копией Ubuntu 24.04 занимают более 20 ГБ ОЗУ. Таким образом, разработка с использованием ИИ и виртуализации изначально требует 32 ГБ ОЗУ.

## Проблема с переразметкой дисков

Первый физический диск в машине - SSD GoodRam 1ТБ. Разбит поровну на системный диск `c:` и диск с исходными текстами `d:`. Поскольку инструментальных средств в системе значительно больше, чем исходных текстов, появились идеи переразметить их в соотношении 7:3. Для решения подобных задач используется утилита "Управление дисками" (`diskmgmt.msc`), в которой диски можно "сжать" и "расширить". Однако, удивительным образом, на машине диск `d:` находился перед диском `c:`, что не дало возможности реализовать задумку - утилита "Управление дисками" умеет расширять том только вправо.

## RTX 5060 8 GB

В конце мая 2026 г. была куплена видеокарта Palit RTX 5060 8 ГБ. Цель - локальный запуск небольших нейронных сетей и ускорение вычислений с использованием CUDA ядер.

Для отключения боковой управляющей панели Nvidia достаточно в настройках приложения "Nvidia App" отключить **Overlay** - это первый пункт в меню.

Загрузка LLM в VRAM занимает ощутимое количество времени, ориентировочно - около минуты. Но затем генерация текста осуществляется быстро. По ощущениям - быстрее, чем через облачные сервисы.

## Проблема с мощностью ИБП

В июне 2026 г. возникла проблема с недостаточной мощностью ИБП IPPON Back Verso 400. Активная мощность у этого ИБП - 200 Вт, чего не хватает при работе системы при запуске Ollama на GPU. Батарея ИБП начинает резко разряжаться, что сопровождается истеричным завыванием сигнализации.

Временно перевожу ПК на розетку с прямым подключением к питанию (без ИБП). 

17 июня 2026 г. была осуществлена покупка IPPON Back Verso 800.

>По счастью, для компьютера Евгения был куплен ИБП IPPON Back Verso 600. Видео-карта RX6600 потребляет 132–140 Вт, что ниже, чем например у RTX 3060, которая потребляет 170 Вт.
