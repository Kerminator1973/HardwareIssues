...
- Увеличение количества исполнительный модулей (_execution engines_). Например, у процессоров Zen 5 количество ALU на одно ядро увеличилось с 4 до 6. Потенциал роста не линейный, т.к. эффективно распараллеливать операции далеко не всегда возможно. Подход эффективен для некоторого подножества алгоритмов.
