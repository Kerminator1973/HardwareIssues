...
Условная стоимость транзистора растёт при переходе на новые технологические нормы. Выпуск процессоров по передовым техпроцессам осуществляется не для снижения стоимости, а для достижения максимальной производительности, т.е. для топового сегмента спроса.
